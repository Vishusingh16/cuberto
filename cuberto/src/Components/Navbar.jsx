...
const Navbar = ({handleEnter, handleLeave, handleClick}) => {
  ...
  return (
    <div>
    <div className='h-[14vh] w-full flex items-center justify-between px-16 bg-white'>
    ...
    <div className='offsetMenu h-screen w-[50vw]  fixed bg-zinc-200 -right-[100%] top-0 z-30'>
